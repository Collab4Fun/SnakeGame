...
function createSnake() {
    for (i = 0; i < snake.length; i++) {
        context.fillStyle = "#A6FC34";
        context.fillRect(snake[i].x, snake[i].y, box, box);
    }
}

function drawFood() {
    context.fillStyle = "#F30203";
...
var activities = document.getElementById("level");
activities.addEventListener("change", function () {
    let level = activities.options[activities.selectedIndex].value;
    if (level == "easy") {
        clearInterval(game);
